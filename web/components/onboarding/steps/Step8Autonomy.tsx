...
const OPTIONS = [
  { 
    value: 1, 
    label: "Sehr wenig", 
    description: "Klare Vorgaben sind mir wichtig",
    icon: "📋"
  },
  { 
    value: 2, 
  ...
  { 
    value: 3, 
    label: "Viel", 
    description: "Ich treffe viele Entscheidungen selbst",
    icon: "🎯"
  },
  { 
    value: 4, 
...
export default function Step8Autonomy({ autonomy, setAutonomy }: Props) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
          🎯 Wie viel Entscheidungsfreiheit möchtest du in deiner täglichen Arbeit haben?
        </h2>
        <p className="text-gray-600 text-sm sm:text-base">
          Wähle dein bevorzugtes Maß an Autonomie
        </p>
      </div>
