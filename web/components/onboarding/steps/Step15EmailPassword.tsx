...
interface Step15EmailPasswordProps {
  email: string;
  password: string;
...
export default function Step15EmailPassword({ 
  email, 
  password,
  passwordConfirm,
  setEmail,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl sm:text-3xl ds-heading mb-3">Fast fertig! 🔐</h2>
        <p className="ds-body-light text-base sm:text-lg">Erstelle jetzt dein Konto mit E-Mail und Passwort</p>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-500 mt-1">Diese E-Mail wird für dein Konto verwendet</p>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`ds-input ds-input-focus-blue text-lg pr-10 ${!passwordLengthValid ? "border-red-500" : ""}`}
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`ds-input ds-input-focus-blue text-lg pr-10 ${!passwordMatch && passwordConfirm !== "" ? "border-red-500" : ""}`}
