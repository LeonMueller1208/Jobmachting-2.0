...
const OPTIONS = [
  ...
  { 
    value: 3, 
    label: "Eher klar", 
    description: "Feste Ebenen helfen mir",
    icon: "📊"
  },
  { 
    value: 4, 
    label: "Sehr klar", 
    description: "Hierarchie gibt mir Sicherheit",
    icon: "🏛️"
  }
];

export default function Step7Hierarchy({ hierarchy, setHierarchy }: Props) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
          🏛️ Welche Art von Hierarchie passt am besten zu dir?
        </h2>
        <p className="text-gray-600 text-sm sm:text-base">
          Wähle deine bevorzugte Hierarchiestruktur
        </p>
      </div>
