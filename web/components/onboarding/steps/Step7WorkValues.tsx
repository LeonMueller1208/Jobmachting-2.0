...
const OPTIONS = [
  { 
    ...
    icon: "🛡️",
    description: "Fester Arbeitsplatz, klare Strukturen"
  },
  { 
    id: "fun", 
    label: "Spaß & gute Atmosphäre", 
    icon: "🎉",
    description: "Nettes Team, lockere Stimmung"
  },
  { 
    id: "development", 
  ...
  { 
    ...
    icon: "🌍",
    description: "Etwas Gutes bewirken"
  }
];

export default function Step7WorkValues({ workValues, setWorkValues }: Props) {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm sm:text-base">
          Wähle 1-2 Dinge aus, die dir am wichtigsten sind
        </p>
      </div>
