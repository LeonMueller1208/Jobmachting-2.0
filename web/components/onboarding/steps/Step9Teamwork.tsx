...
const OPTIONS = [
  { 
    value: 1, 
    label: "Sehr wichtig", 
    description: "Ich arbeite fast immer im Team",
    icon: "👥"
  },
  { 
    value: 2, 
  ...
  { 
    ...
    description: "Ich arbeite meist allein",
    icon: "👤"
  },
  { 
    value: 4, 
    label: "Unwichtig", 
    description: "Ich arbeite am liebsten selbstständig",
    icon: "🎯"
  }
];

export default function Step9Teamwork({ teamwork, setTeamwork }: Props) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
          👥 Wie wichtig ist dir Zusammenarbeit im Team?
        </h2>
