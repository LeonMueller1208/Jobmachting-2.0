...
interface CompanyStep5EmailPasswordProps {
  email: string;
  password: string;
...
export default function CompanyStep5EmailPassword({ 
  email, 
  password,
  passwordConfirm,
  setEmail,
  setPassword,
  setPasswordConfirm
}: CompanyStep5EmailPasswordProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="ds-body-light text-base sm:text-lg">Erstellen Sie jetzt Ihr Konto mit E-Mail und Passwort</p>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-500 mt-1">Diese E-Mail wird für Ihr Konto verwendet</p>
      </div>
      ...
      <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-green-800">
            Ihre Daten werden sicher gespeichert und nur für das Job-Matching verwendet. 
