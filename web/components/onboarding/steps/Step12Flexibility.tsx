...
const OPTIONS = [
  { 
    value: 1, 
    label: "Sehr wichtig", 
    description: "Ohne Flexibilität geht es nicht",
    icon: "🔄"
  },
  { 
    value: 2, 
    label: "Wichtig", 
    description: "Ein Plus, aber kein Muss",
    icon: "⚖️"
  },
  { 
    value: 3, 
  ...
  { 
    value: 4, 
    label: "Unwichtig", 
    description: "Feste Strukturen bevorzuge ich",
    icon: "📅"
  }
];

export default function Step12Flexibility({ flexibility, setFlexibility }: Props) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
          🔄 Wie wichtig sind dir flexible Arbeitszeiten oder Arbeitsorte?
        </h2>
        <p className="text-gray-600 text-sm sm:text-base">
          Wähle deine bevorzugte Flexibilität
        </p>
      </div>
