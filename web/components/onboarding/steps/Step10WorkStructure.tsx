...
export default function Step10WorkStructure({ workStructure, setWorkStructure }: Props) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm sm:text-base mb-4">
          Ich arbeite am liebsten in einem strukturierten und planbaren Arbeitsalltag.
        </p>
