      ...
      <main className="max-w-2xl mx-auto px-6 py-8">
        <div className="ds-card p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl ds-heading mb-2">Unternehmen registrieren</h1>
            <p className="ds-body-light text-sm sm:text-base lg:text-lg">Erstellen Sie Ihr Unternehmensprofil</p>
          </div>
