    ...
    <div className="ds-background min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl ds-heading mb-4">Unternehmen Bereich</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href="/company/register" className="ds-card ds-card-hover p-8 text-center group">
            ...
            <h2 className="text-xl ds-subheading mb-4">Neues Unternehmen registrieren</h2>
            <p className="ds-body-light">Registrieren Sie Ihr Unternehmen und erstellen Sie Stellenangebote</p>
          </Link>
          ...
          <Link href="/company/login" className="ds-card ds-card-hover p-8 text-center group">
            ...
            <p className="ds-body-light">Melden Sie sich mit Ihrem bestehenden Unternehmensprofil an</p>
          </Link>
        </div>
      </main>
    </div>
