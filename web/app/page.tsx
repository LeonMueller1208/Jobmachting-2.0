    ...
    <div className="ds-background min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h1 className="text-3xl ds-heading tracking-tight mb-3">
            Intelligente Jobvermittlung
          </h1>
          <p className="text-lg ds-body max-w-xl mx-auto leading-relaxed px-4 sm:px-0">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-6 mt-8 sm:mt-12 lg:mt-14 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-xl ds-subheading mb-2 sm:mb-3 group-hover:text-[var(--accent-blue)] transition-all duration-500 ease-out">
                Job suchen
              </h2>
              <p className="ds-body-light leading-relaxed">
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-xl ds-subheading mb-2 sm:mb-3 group-hover:text-[var(--accent-green)] transition-all duration-500 ease-out">
                Stellen anbieten
              </h2>
              <p className="ds-body-light leading-relaxed">
