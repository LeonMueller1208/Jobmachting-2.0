    ...
    <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen">
      <main className="mx-auto max-w-md px-6 py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Als Bewerber anmelden</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-8">
          <div className="space-y-6">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="text-center">
              <p className="text-gray-600">
                Noch kein Konto?{" "}
                <Link href="/applicant/register" className="text-blue-600 hover:text-blue-700 font-medium">
                  Registrieren
                </Link>
              </p>
            </div>
