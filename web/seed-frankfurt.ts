...
// Load environment variables manually (dotenv hat Probleme mit Sonderzeichen)
...
async function main() {
  ...
  console.log('✅ DATABASE_URL gefunden (Länge:', process.env.DATABASE_URL.length, 'Zeichen)\n');
